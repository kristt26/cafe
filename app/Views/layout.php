...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" style="background-image: linear-gradient(180deg,#6a5025 10%,#685535 100%) !important;" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" style="background-color: #dbaf67;" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url("assets/img/logo.png") ?>" width="100%" alt="">
                </div>
                <div class="sidebar-brand-text mx-3">Pemilihan Cafe </div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content">
                <nav class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow" style="background-color: #ebb342 !important;">
